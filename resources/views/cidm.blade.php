...
<div class="container">
	...
	<div class="form-group row">
		<div class="col-lg-10 mx-auto">
			...
			<div class="row">
				<div class="col-lg-12 ">
					 <h4 class="mb-0 ml-3"><b>CIDM</b></h4>
					 <br>
				</div>
			</div>
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#bos1">BOS1</a></li>
				<li><a data-toggle="tab" href="#bos2">BOS2</a></li>
				<li><a data-toggle="tab" href="#mim">MIM</a></li>
				<li><a data-toggle="tab" href="#rcs">RCS</a></li>
			</ul>


			<div class="tab-content">
				<div id="bos1" class="tab-pane fade in active">
					bos1
				</div>
				<div id="bos2" class="tab-pane fade">
					bos2
				</div>
				<div id="mim" class="tab-pane fade">
					mim
				</div>
						...
						<form>
								...
								<div class="row">
									<div class="col-12 text-center">
										...
										<button type="submit" class="btn btn-none">Cancel</button>
