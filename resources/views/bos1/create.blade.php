			...
			<div class="card border-0">
				<div class="card-body bg-light">
					<div class="inner-bos-one ">
						<form id="bos1Form">
							<input type="hidden" name="system" value="BOS1">
									...
									<div class="row">
										<div class="col-lg-6 col-ms-6 col-sm-12 col-12">
											<div class="form-group">
												...
												<input  type="text" class="form-control" name="name_middle" placeholder="" id="name_middle">
											</div>
										</div>
										<div class="col-lg-6 col-ms-6 col-sm-12 col-12">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-lg-6 col-ms-6 col-sm-12 col-12">
											<div class="form-group">
												...
												<div class="common-err-msg" style="display: none;">CRN or Driver license Or Passport or Medicare card is required</div>
