   ...
   public function handle()
    {
        try{
           ...
           $ClientId = $this->clientId;
            ...
            $previousData = BOS1::where('client_id',$ClientId)->first();
             $find = BOS1::where('client_id','=',$ClientId)->get();
            ...
            if(count($find)>0){
                ...
                $prev_data = json_encode($previousData);
                        $logs = array('system_id'=>$previousData->bos1_id,'system_name'=>'BOS1','client_id'=>$previousData->client_id,'action_performed'=>'Update','previous_data'=>$prev_data);
